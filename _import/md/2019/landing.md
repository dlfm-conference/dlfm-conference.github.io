...
<div class="panelizer-view-mode node node-full node-oxdrupal-basic-page node-645686">
...
<div class="entity entity-paragraphs-item paragraphs-item-wysiwyg-content-area margin-bottom widget-width-8-columns widget-style-main paragraphs-item-1103716">

<div id="widget-id-1103716">
...
- **09/11/2019**: The [proceedings of DLfM 2019](https://dlfm.web.ox.ac.uk/2019-proceedings) are now available as open access from the conference website.
- **24/10/2019**: The [full programme](https://dlfm.web.ox.ac.uk/2019-programme) is now available online.
- **09/09/2019**: The list of accepted papers is now published.
- **06/09/2019**: Registration and payment are now available.
- **17/08/2019**: Some instructions for the camera-ready submission have been added.
...
- **12/06/2019**: Information about our building and directions are available at <a href="https://www.kb.nl/en/visitors/address-and-directions" target="_blank">https://www.kb.nl/en/visitors/address-and-directions</a>.
...
- The full programme can be accessed [here](https://dlfm.web.ox.ac.uk/2019-programme).
...
The **National Library of the Netherlands** is easily reached by train from Delft. You can plan your trip from door to door at <https://9292.nl/en>. Trains from **Delft** and **Delft Zuid** go directly to **Den Haag Centraa**l in 15-20 minutes and go multiple times per hour. The library is within walking distance from Den Haag Centraal.

For detailed directions, please see <https://www.kb.nl/en/visitors/address-and-directions>.

 

## <span id="CFP"></span>Call for papers
...
This, the Sixth Digital Libraries for Musicology conference, follows previous workshops in London, Knoxville, New York, Shanghai, and Paris. In 2019, DLfM is again proud to be a satellite event of the annual [International Society for Music Information Retrieval](http://ismir2019.ewi.tudelft.nl/) (ISMIR) conference which is being held in Delft, and in particular encourages reports on the use of MIR methods and technologies within Music Digital Library systems when applied to the pursuit of musicological research.

 

### <span id="Scope"></span>Scope and objectives
...
- Submissions:** **<https://easychair.org/conferences/?conf=dlfm2019>
- Contact email: <dlfm2019@easychair.org>

**Paper template**

- ACM template (both Word and LaTeX): <https://www.acm.org/publications/taps/word-template-workflow>
  - The template for the first submission must be *sigconf-authordraft*.

**Camera-ready instructions**

- Please format your paper for the camera-ready submission using the *sigconf* template. Questions regarding the ACM manuscript templates MUST be directed to the ACM TeX support team at Aptara directly at  <acmtexsupport@aptaracorp.com>.
...
### <span id="Dates"></span>Important dates

- Abstract submission deadline: **29th June 2019 **~~21th June 2019~~
- Paper submission deadline: ~~**6th July 2019**~~ ~~28th June 2019~~
- TROMPA Project Challenge: ~~**18th July 2019**~~
...
Mario Rodríguez-Ruiz, Instituto Superior de Enseñanzas Artísticas de la Comunidad Valenciana

Manuel Mas, Instituto Superior de Enseñanzas Artísticas de la Comunidad Valenciana
...
<div class="entity entity-paragraphs-item paragraphs-item-wysiwyg-content-area margin-bottom widget-width-12-columns widget-style-main paragraphs-item-1103751">

<div id="widget-id-1103751">
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/dlfm/images/media/icps-acm.png?itok=zld4JGlJ" title="ICPS Publiched by ACM" class="img-responsive" alt="ICPS Publiched by ACM" />
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/top-bar-logo_0_0_0.png?itok=8l_mVavi" title="TROMPA" class="img-responsive" alt="TROMPA" />
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/formato3_0.png?itok=XTI_ZvF1" title="IUII" class="img-responsive" alt="IUII" />
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/dlfm/images/media/isea.jpg?itok=kPw_10CI" title="ISEA CV" class="img-responsive" alt="ISEA CV" />
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/mineco_peq.png?itok=59bzgULO" title="Mineco peq" class="img-responsive" alt="mineco peq" />
