...
<div class="panelizer-view-mode node node-full node-oxdrupal-basic-page node-248901">
...
<div class="entity entity-paragraphs-item paragraphs-item-wysiwyg-content-area margin-bottom widget-width-8-columns paragraphs-item-432666">

<div id="widget-id-432666">
...
- 19/03/2018: *Colleagues particularly interested in modelling audio and music, or are using semantic web technologies in their music-related research are also encouraged to consider our sister workshop, [Semantic Applications for Audio and Music](http://saam.semanticaudio.ac.uk/) to be held at Monterey, California on October 9, 2018.*
...
This, the fifth Digital Libraries for Musicology conference, follows previous workshops in London, Knoxville, New York, and Shanghai. In 2018, DLfM is again proud to be a satellite event of the annual [International Society for Music Information Retrieval](http://ismir2018.ircam.fr/) (ISMIR) conference also being held in Paris, and in particular encourages reports on the use of MIR methods and technologies within Music Digital Library systems when applied to the pursuit of musicological research.
...
- Submissions: <https://easychair.org/conferences/?conf=dlfm2018>
- Contact email: [dlfm2018@easychair.org](mailto:https://easychair.org/conferences/?conf=dlfm2018)

 

Please use the ‘ACM Standard’ version of the ‘ACM proceedings template’ – for MS Word, see ACM_SigConf, for LaTeX, sample-sigconf.

#### <span id="Proceedings-track"></span>Submissions: Proceedings track
...
#### <span id="Unlocking-musicology"></span>Submissions: Unlocking Musicology Challenge
...
<div class="entity entity-paragraphs-item paragraphs-item-wysiwyg-content-area margin-bottom widget-width-12-columns paragraphs-item-443601">

<div id="widget-id-443601">
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/dlfm/images/media/iremus-logo-noir-et-couleur.jpg?itok=dI1t-PQu" title="IReMus (Institut de recherche en musicologie)" class="img-responsive" alt="Logo for Institut de recherche en musicologie (IReMus)" />
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/tm/images/media/uni_centre_logo_pair_small.png?itok=pWpD3pQc" title="University of Oxford e-Research Centre" class="img-responsive" alt="University of Oxford e-Research Centre logos" />
...
<img src="https://dlfm.web.ox.ac.uk/sites/default/files/styles/mt_image_small/public/dlfm/images/media/trompa-top-bar-logo_0_0.png?itok=keW_04N8" title="TROMPA" class="img-responsive" alt="TROMPA" />
